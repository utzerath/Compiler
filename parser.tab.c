...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_OPEN_BRACE = 13,                /* OPEN_BRACE  */
  YYSYMBOL_CLOSE_BRACE = 14,               /* CLOSE_BRACE  */
  ...
  YYSYMBOL_LValue = 26,                    /* LValue  */
  YYSYMBOL_Expr = 27,                      /* Expr  */
  YYSYMBOL_BinOp = 28                      /* BinOp  */
};
...
{
       0,    62,    62,    71,    74,    82,    96,   111,   116,   117,
     125,   132,   138,   146,   152,   161,   169,   173,   177,   183,
     190,   196,   197,   198,   199
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "TYPE", "NUMBER",
  "FLOAT_LITERAL", "SEMICOLON", "EQ", "PLUS", "MINUS", "MULTIPLY",
  "DIVIDE", "WRITE", "OPEN_BRACE", "CLOSE_BRACE", "OPEN_PAREN",
  "CLOSE_PAREN", "ID", "OPEN_BRACKET", "CLOSE_BRACKET", "$accept",
  "Program", "VarDeclList", "VarDecl", "StmtList", "Stmt", "LValue",
  "Expr", "BinOp", YY_NULLPTR
};
...
{
       4,   -14,    13,    15,     4,    -1,   -19,    -3,    15,    -8,
     -19,    15,     9,   -19,   -19,    22,   -19,   -19,    -3,    12,
      35,    17,    -3,   -19,    -3,    19,    26,    -3,   -19,   -19,
     -19,   -19,   -19,    -3,   -19,    10,    41,    33,   -19,    14,
      45,   -19,   -19,   -19,   -19
};
...
{
       3,     0,     0,     8,     3,     7,     1,     0,     8,    13,
       2,     8,     0,     4,     5,     0,    16,    17,     0,    18,
       0,     0,     0,     9,     0,     0,     0,     0,    11,    21,
      22,    23,    24,     0,    12,     0,     0,     0,    20,     0,
      15,    14,    10,     6,    19
};
...
{
     -19,   -19,    36,   -19,     0,   -19,   -19,   -18,   -19
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     2,     3,     4,    10,    11,    12,    20,    33
};
...
{
      26,    16,    17,     5,    35,    14,    36,     1,    21,    39,
      22,    23,    18,     6,    19,    40,    24,    15,    29,    30,
      31,    32,    29,    30,    31,    32,    25,     7,     8,    41,
      27,    34,     9,    44,    29,    30,    31,    32,    37,    43,
      13,    28,    38,    29,    30,    31,    32,    42,     0,    29,
      30,    31,    32,    29,    30,    31,    32
};

static const yytype_int8 yycheck[] =
{
      18,     4,     5,    17,    22,     6,    24,     3,     8,    27,
      18,    11,    15,     0,    17,    33,     7,    18,     8,     9,
      10,    11,     8,     9,    10,    11,     4,    12,    13,    19,
      18,    14,    17,    19,     8,     9,    10,    11,    19,     6,
       4,     6,    16,     8,     9,    10,    11,     6,    -1,     8,
       9,    10,    11,     8,     9,    10,    11
};
...
{
       0,     3,    21,    22,    23,    17,     0,    12,    13,    17,
      24,    25,    26,    22,     6,    18,     4,     5,    15,    17,
      27,    24,    18,    24,     7,     4,    27,    18,     6,     8,
       9,    10,    11,    28,    14,    27,    27,    19,    16,    27,
      27,    19,     6,     6,    19
};
...
#line 82 "parser.y"
    ...
    if (symbol != NULL) {
        ...
        (yyval.ast)->varDecl.varType = strdup((yyvsp[-2].string));  // Can be "int" or "float"
        (yyval.ast)->varDecl.varName = strdup((yyvsp[-1].string));
        addSymbol(symTab, (yyvsp[-1].string), (yyvsp[-2].string), 0);  // Add symbol to symbol table
    }
}
#line 1176 "parser.tab.c"
    break;

  case 6: /* VarDecl: TYPE ID OPEN_BRACKET NUMBER CLOSE_BRACKET SEMICOLON  */
#line 96 "parser.y"
                                                      {
    ...
    if (symbol != NULL) {
        ...
        addSymbol(symTab, (yyvsp[-4].string), (yyvsp[-5].string), (yyvsp[-2].number));  // Add symbol to symbol table
    }
}
...
#line 1221 "parser.tab.c"
  ...
  case 10: /* Stmt: LValue EQ Expr SEMICOLON  */
#line 125 "parser.y"
                               {
...
#line 1233 "parser.tab.c"
  ...
  case 11: /* Stmt: WRITE Expr SEMICOLON  */
#line 132 "parser.y"
                          { 
...
#line 1244 "parser.tab.c"
  ...
  case 12: /* Stmt: OPEN_BRACE StmtList CLOSE_BRACE  */
#line 138 "parser.y"
                                     {
...
#line 1266 "parser.tab.c"
  ...
  case 14: /* LValue: ID OPEN_BRACKET Expr CLOSE_BRACKET  */
#line 152 "parser.y"
                                     {
...
#line 161 "parser.y"
    ...
    (yyval.ast)->expr.operator = (yyvsp[-1].character);  // Use operator directly from BinOp
}
...
#line 169 "parser.y"
    ...
    (yyval.ast) = createIntNode((yyvsp[0].number));  // Create a node for integer value
}
...
#line 173 "parser.y"
    ...
    (yyval.ast) = createFloatNode((yyvsp[0].float_number));  // Create a node for float value
}
...
#line 1320 "parser.tab.c"
  ...
  case 19: /* Expr: ID OPEN_BRACKET Expr CLOSE_BRACKET  */
#line 183 "parser.y"
                                     {
...
#line 1353 "parser.tab.c"
  ...
  case 23: /* BinOp: MULTIPLY  */
#line 198 "parser.y"
                { (yyval.character) = '*'; }
#line 1359 "parser.tab.c"
    break;

  case 24: /* BinOp: DIVIDE  */
#line 199 "parser.y"
               { (yyval.character) = '/'; }
