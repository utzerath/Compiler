...
static const char *const yytname[] =
{
  ...
  "Stmt", "LValue", "Expr", "FuncCall", "ArgList", "BinOp", YY_NULLPTR
};
#endif
...
#line 82 "parser.y"
    ...
    (yyval.ast)->program.varDeclList = (yyvsp[-2].ast); // Global variables
    (yyval.ast)->program.funcDeclList = (yyvsp[-1].ast); // Function declarations
    (yyval.ast)->program.stmtList = (yyvsp[0].ast); // Statements
}
...
#line 88 "parser.y"
    ...
    (yyval.ast)->program.funcDeclList = (yyvsp[-1].ast); 
...
#line 109 "parser.y"
        ...
        root = malloc(sizeof(ASTNode));
        root->type = NodeType_Program;
        root->program.varDeclList = (yyvsp[0].ast);
        root->program.funcDeclList = NULL;
...
#line 120 "parser.y"
        ...
        root->program.funcDeclList = (yyvsp[0].ast);
        root->program.stmtList = NULL;
    }
...
#line 143 "parser.y"
        ...
        (yyval.ast)->varDeclList.varDecl = (yyvsp[-1].ast);  // The current variable declaration
        (yyval.ast)->varDeclList.varDeclList = (yyvsp[0].ast);  // The rest of the variable declarations
    }
...
#line 166 "parser.y"
        ...
        (yyval.ast) = createFuncDeclNode((yyvsp[-5].string), (yyvsp[-4].string), NULL, NULL, NULL); // No body, no return statement
    }
...
#line 170 "parser.y"
        ...
        (yyval.ast) = createFuncDeclNode("void", (yyvsp[-4].string), NULL, NULL, NULL); // No body
    }
...
#line 174 "parser.y"
                                                                                          {
        printf("PARSER: Recognized function declaration: %s\n", (yyvsp[-7].string));
        (yyval.ast) = createFuncDeclNode((yyvsp[-8].string), (yyvsp[-7].string), (yyvsp[-5].ast), (yyvsp[-2].ast), (yyvsp[-1].ast)); // Body present
    }
...
#line 178 "parser.y"
                                                                               {
        printf("PARSER: Recognized void function declaration: %s\n", (yyvsp[-6].string));
        (yyval.ast) = createFuncDeclNode("void", (yyvsp[-6].string), (yyvsp[-4].ast), (yyvsp[-1].ast), NULL); // No return statement
    }
...
#line 187 "parser.y"
            {
        (yyval.ast) = createParamNode((yyvsp[-1].string), (yyvsp[0].string));  // Assuming createParamNode returns a Param*
    }
...
#line 194 "parser.y"
        {
    (yyval.ast) = createParamListNode((yyvsp[0].ast), NULL);
}
...
#line 197 "parser.y"
                        {
    (yyval.ast) = createParamListNode((yyvsp[-2].ast), (yyvsp[0].ast));
}
...
#line 205 "parser.y"
    ...
    (yyval.ast) = createReturnNode((yyvsp[-1].ast));
}
...
#line 227 "parser.y"
    ...
    if (symbol != NULL) {
        ...
        (yyval.ast)->varDecl.varType = strdup((yyvsp[-2].string));  // Store type
        (yyval.ast)->varDecl.varName = strdup((yyvsp[-1].string));  // Store variable name
        addSymbol(symTab, (yyvsp[-1].string), (yyvsp[-2].string), 0, NULL, NULL); // Add symbol to the symbol table
    }
}
...
#line 242 "parser.y"
    ...
    symbol = lookupSymbol(symTab, (yyvsp[-4].string));
    if (symbol != NULL) {
        ...
        (yyval.ast)->arrayDecl.varType = strdup((yyvsp[-5].string));  // Can be "int" or "float"
        (yyval.ast)->arrayDecl.varName = strdup((yyvsp[-4].string));
        (yyval.ast)->arrayDecl.size = (yyvsp[-2].number);
        addSymbol(symTab, (yyvsp[-4].string), (yyvsp[-5].string), 0, NULL, NULL);  // Add array symbol to symbol table
    }
}
...
#line 270 "parser.y"
        ...
        (yyval.ast) = createNode(NodeType_StmtList);
        (yyval.ast)->stmtList.stmt = (yyvsp[-1].ast);  // Treat VarDecl as a statement within StmtList
...
#line 340 "parser.y"
           {
    (yyval.ast) = (yyvsp[0].ast);  // Return the result of function call
}
...
#line 350 "parser.y"
    ...
    (yyval.ast) = (yyvsp[-1].ast);  // Just return the expression inside parentheses
}
