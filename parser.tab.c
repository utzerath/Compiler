...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_VarDeclList = 16,               /* VarDeclList  */
...
static const char *const yytname[] =
{
  ...
  "SEMICOLON", "EQ", "PLUS", "MULTIPLY", "DIVIDE", "NUMBER", "WRITE",
  "OPEN_BRACE", "CLOSE_BRACE", "$accept", "Program", "VarDeclList",
...
#line 67 "parser.y"
    ...
    (yyval.ast)->varDeclList.varDecl = (yyvsp[-1].ast);  // Store the current VarDecl
    (yyval.ast)->varDeclList.varDeclList = (yyvsp[0].ast);  // Link to the next VarDeclList (or NULL if end)
}
...
#line 120 "parser.y"
       ...
       (yyval.ast)->assignStmt.varName = strdup((yyvsp[-3].string));  // Store the variable name
       (yyval.ast)->assignStmt.operator = (yyvsp[-2].operator);         // Store the assignment operator (if needed)
       (yyval.ast)->assignStmt.expr = (yyvsp[-1].ast);             // Link the expression subtree
     }
#line 1216 "parser.tab.c"
    break;

  case 10: /* Stmt: WRITE Expr SEMICOLON  */
#line 128 "parser.y"
       ...
       (yyval.ast)->writeStmt.expr = (yyvsp[-1].ast);              // Store the expression being written
     }
#line 1227 "parser.tab.c"
    break;

  case 11: /* Stmt: OPEN_BRACE StmtList CLOSE_BRACE  */
#line 134 "parser.y"
                                     {  // Handle block of statements
       printf("PARSER: Recognized a block statement\n");
       (yyval.ast) = malloc(sizeof(ASTNode));
       (yyval.ast)->type = NodeType_BlockStmt;
       (yyval.ast)->blockStmt.stmtList = (yyvsp[-1].ast);          // Link to the statement list
     }
